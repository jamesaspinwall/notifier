...
class NoticeTest < ActiveSupport::TestCase
  ...
  test 'notice1' do
    ...
    assert_difference 'Notice.count' do
      notice = Notice.create notice_attrs(notify_chronic: 'tomorrow 11 AM')
  ...
  test 'validator must be in the future' do
    assert_difference 'Notice.count', 0 do
      ['12:00 AM','yesterday'].each do |notify_at|
        notice = Notice.create notice_attrs(notify_chronic: notify_at)
  ...
  test 'invalid chonic' do
    notice = Notice.create notice_attrs(notify_chronic: 'this is not chronic')
    refute_empty notice.errors.messages[:notify_at]
  end

  test 'soonest valid' do
    assert_nil Notice.earliest
    n5 = Notice.create notice_attrs(notify_chronic: 'in 5 secs')
    n2 = Notice.create notice_attrs(notify_chronic: 'in 2 secs')
    assert_equal n2, Notice.earliest
    n2.sent
    n3 = Notice.create notice_attrs(notify_chronic: 'in 3 secs')
